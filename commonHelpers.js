...
</div>`}function h(){return c.map(g).join("")}function y(){const e=h();m.innerHTML=e,console.log("render")}function b(){let e={captionsData:"alt",captionDelay:250,captions:!0},r=new u(".container-image",e);r.on("show.simplelightbox",function(){}),r.refresh()}
